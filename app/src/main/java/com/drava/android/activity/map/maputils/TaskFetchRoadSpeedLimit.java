...
public class TaskFetchRoadSpeedLimit extends AsyncTask<Void, Void, String> {
    ...
    public TaskFetchRoadSpeedLimit(UpdateMaxSpeed listener, LatLng southwest, LatLng northeast, Context context) {
    ...
    protected void onPostExecute(String response) {
        ...
        if (!TextUtils.isEmpty(response)) {
            ...
            try {
                ...
                AppLog.print(context, "===>Max speed error:<===="+e.getLocalizedMessage());
                e.printStackTrace();
            }
        }

        HomeFragment.isWebServiceRunnig = false;
    }
